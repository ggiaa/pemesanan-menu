    ...
    <div class="w-1/4 text-lg">
        <form action="/dashboard/menu/{{ $menu->slug }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group pb-5 flex flex-col">
                ...
                <input id="nama" value="{{ old('nama',$menu->nama) }}" class="form-control w-full border border-slate-600 focus:outline-none rounded-lg p-1 focus:ring-2 focus:ring-accent" type="text" name="nama" autofocus autocomplete="off">
                @error('nama')
            ...
            <div class="form-group pb-5 flex flex-col">
                ...
                <input id="harga" value="{{ old('harga', $menu->harga) }}" class="form-control w-full border border-slate-600 focus:outline-none rounded-lg p-1 focus:ring-2 focus:ring-accent" type="number" name="harga" autocomplete="off">
                @error('harga')
                <div class="text-red-500 text-sm">
                    {{ $message }}
                </div>
